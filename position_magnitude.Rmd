...
risk1_anon <- read_csv("risk1_anon.csv")
risk2_anon <- read_csv("risk2_anon.csv")
risk3_anon <- read_csv("risk3_anon.csv")
```
...
knitr::include_graphics("nyt-chart.png")
```
...
img1 <- image_read("E23_hi.png")
img2 <- image_read("E23_lo.png")
...
knitr::include_graphics("example_trial.png")
```
