...
Write a script to check this number
...
Due to experimenter error, data from one participant was collected prior to pre-registration. These data are not included in the analysis.
...
Materials were identical to E1, except for the inversion of the y-axis in all charts, including practice items. There were 60 trials in total (40 experimental, 15 fillers, 5 attention check questions). Did the item that changed in E2 also change here?

### Participants

How many people participated in total?

What were the entire elimiation criteria on pre-reg?

The experiment was not made available to those who had participated in Experiments 1 and 2 or those who signed-up to prolific.co prior to 24th July 2021. A viral social media post on 24th July 2021 endorsing the website attracted many new users from a narrow demographic, skewing studies' participant distributions (Prolific, 2021).
