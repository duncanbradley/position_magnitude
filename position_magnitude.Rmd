...
index_terms: "Data cognition, framing effects, chart design, axis range, magnitude judgements."
...
at lower positions. Experimental code, materials and a link to run the experiment are available at https://gitlab.pavlovia.org/ExPrag_UoM/riskE1.
...
Analyses were conducted using R (version 4.1.2, [@r_core_team_r_2021]).
...
to conventional charts). Experimental code, materials and a link to run the experiment are available at https://gitlab.pavlovia.org/ExPrag_UoM/riskE2.
...
positions (the reverse of the finding for conventional charts). Experimental code, materials and a link to run the experiment are available at https://gitlab.pavlovia.org/ExPrag_UoM/riskE3.
